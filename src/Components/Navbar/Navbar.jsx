  ...
  return (
    <div>
      <div className="flex gap-4 px-[5vw] w-full items-center justify-between py-5 text-white min-h-[98px] max-w-screen-2xl mx-auto">
        ...
        <div
          className={`max-md:fixed max-md:w-[60vw] duration-300  z-10 max-md:h-full max-md:bg-[#1a1a1a] max-md:flex-col items-center max-md:justify-center max-md:shadow flex gap-6 justify-between max-md:top-0 ${
